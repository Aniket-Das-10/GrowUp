  ...
  return (
    <>
      ...
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        <div className="section_heading text-2xl text-richblack-5">Courses to get you started</div>
      ...
      {/* Section 2 */}
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        <div className="section_heading text-2xl text-richblack-5">
      ...
      {/* Section 3 */}
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        <div className="section_heading text-2xl text-richblack-5">Frequently Bought</div>
        <div className="py-8">
