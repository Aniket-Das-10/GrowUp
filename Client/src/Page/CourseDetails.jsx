...
function CourseDetails() {
  ...
  useEffect(() => {
    // Calling fetchCourseDetails function to fetch the course details
    ;(async () => {
      try {
  ...
  return (
    <>
      <div className={`relative w-full bg-richblack-800`}>
        ...
        {/* Hero Section */}
        <div className="mx-auto box-content px-4 lg:relative lg:max-w-maxContent ">
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:max-w-maxContent">
      ...
      {/* Review Section */}
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:max-w-maxContent py-12">
